...
const STATUS_TONE: Record<string, keyof typeof TONE_CLASS> = {
  ...
  PAYMENT_SUBMITTED: "sky",
  PAYMENT_DETECTED: "blue",
  PAYMENT_CONFIRMED: "emerald",
  SETTLEMENT_PENDING: "gold",
  SETTLEMENT_IN_PROGRESS: "blue",
  SETTLEMENT_SENT: "sky",
  CONFIRMING: "blue",
  CONFIRMED: "emerald",
  COMPLETED: "emerald",
  ...
  REFUNDED: "slate",
  EXPIRED: "rose",
  // Customer methods, capacity and reconciliation
  FORMAT_VALIDATED: "sky",
  OWNERSHIP_VERIFIED: "emerald",
  UNVERIFIED: "gold",
  AVAILABLE: "emerald",
  PAUSED: "slate",
  OFFLINE: "rose",
