      ...
      <div className="not-prose mt-3 grid gap-x-6 gap-y-4 sm:grid-cols-2">
        {CRITERIA.map((c) => (
          <div key={c.title} className="flex gap-3">
            <span className="mt-0.5 flex h-[20px] w-[20px] shrink-0 items-center justify-center rounded-md border border-emerald-400/50 bg-emerald-50 text-[10px] text-emerald-600">
              ✓
            </span>
            <div>
